...
@section('page-title', 'Chỉnh sửa Bãi đỗ xe - Paspark Admin')
@section('page-heading', 'Chỉnh sửa Bãi đỗ xe')
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
            <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                <div class="flex items-center justify-between mb-4">
                    <h6 class="mb-0 dark:text-white">Chỉnh sửa: {{ $parkingLot->name }}</h6>
                    <div class="space-x-2">
                        <a href="{{ route('admin.parking-lots.show', $parkingLot) }}" class="inline-block px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all bg-transparent rounded-lg cursor-pointer bg-gradient-to-tl from-orange-500 to-yellow-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85 hover:shadow-soft-xs">
                ...
                <form method="POST" action="{{ route('admin.parking-lots.update', $parkingLot) }}">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $parkingLot->name) }}" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Nhập tên bãi đỗ xe" required>
                            @error('name')
                        ...
                        <div class="w-full max-w-full px-3 mb-6">
                            ...
                            <input type="text" name="address" id="address" value="{{ old('address', $parkingLot->address) }}" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Nhập địa chỉ chi tiết" required>
                            @error('address')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none">
                            ...
                            <input type="number" name="longitude" id="longitude" value="{{ old('longitude', $parkingLot->longitude) }}" step="any" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Vd: 105.804817">
                            @error('longitude')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full max-w-full px-3 mb-6 md:w-4/12 md:flex-none">
                            ...
                            <input type="number" name="total_spots" id="total_spots" value="{{ old('total_spots', $parkingLot->total_spots) }}" min="1" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Vd: 100" required>
                            @error('total_spots')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full max-w-full px-3 mb-6 md:w-4/12 md:flex-none">
                            ...
                            <input type="number" name="available_spots" id="available_spots" value="{{ old('available_spots', $parkingLot->available_spots) }}" min="0" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Vd: 100" required>
                        ...
                        <div class="w-full max-w-full px-3 mb-6 md:w-4/12 md:flex-none">
                            ...
                            <input type="number" name="hourly_rate" id="hourly_rate" value="{{ old('hourly_rate', $parkingLot->hourly_rate) }}" min="0" step="1000" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" placeholder="Vd: 15000" required>
                            @error('hourly_rate')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none">
                            ...
                            <select name="status" id="status" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow" required>
                                ...
                                <option value="active" {{ old('status', $parkingLot->status) == 'active' ? 'selected' : '' }}>Hoạt động</option>
                                <option value="inactive" {{ old('status', $parkingLot->status) == 'inactive' ? 'selected' : '' }}>Không hoạt động</option>
                                <option value="maintenance" {{ old('status', $parkingLot->status) == 'maintenance' ? 'selected' : '' }}>Bảo trì</option>
                            </select>
                            @error('status')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
