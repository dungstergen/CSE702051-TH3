        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors dark:text-white dark:opacity-80 @if(Request::routeIs('admin.dashboard')) bg-blue-500/13 rounded-lg font-semibold text-slate-700 @endif"
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors dark:text-white dark:opacity-80 @if(Request::routeIs('admin.parking')) bg-blue-500/13 rounded-lg font-semibold text-slate-700 @endif"
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors dark:text-white dark:opacity-80 @if(Request::routeIs('admin.customers')) bg-blue-500/13 rounded-lg font-semibold text-slate-700 @endif"
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors dark:text-white dark:opacity-80 @if(Request::routeIs('admin.reports')) bg-blue-500/13 rounded-lg font-semibold text-slate-700 @endif"
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors dark:text-white dark:opacity-80 @if(Request::routeIs('admin.revenue')) bg-blue-500/13 rounded-lg font-semibold text-slate-700 @endif"
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors dark:text-white dark:opacity-80 @if(Request::routeIs('admin.users')) bg-blue-500/13 rounded-lg font-semibold text-slate-700 @endif"
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors dark:text-white dark:opacity-80 @if(Request::routeIs('admin.settings')) bg-blue-500/13 rounded-lg font-semibold text-slate-700 @endif"
                ...
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']"
                            aria-current="page">@yield('breadcrumb', 'Admin')</li>
                    </ol>
                    <h6 class="mb-0 font-bold text-white capitalize">@yield('page_title', 'Quản lý hệ thống bãi đỗ xe')
                    </h6>
                </nav>
                                        ...
                                        <div class="flex py-1">
                                            ...
                                            <div class="flex flex-col justify-center">
                                                <h6 class="mb-1 text-sm font-normal leading-normal dark:text-white">
                                                    <span class="font-semibold">Tin nhắn mới</span> từ Laur</h6>
                                ...
                                <li class="relative mb-2">
                                    <a class="dark:hover:bg-slate-900 ease py-1.2 clear-both block w-full whitespace-nowrap rounded-lg px-4 transition-colors duration-300 hover:bg-gray-200 hover:text-slate-700"
                                        ...
                                        <div class="flex py-1">
                                            ...
                                            <div class="flex flex-col justify-center">
                                                <h6 class="mb-1 text-sm font-normal leading-normal dark:text-white">
                                                    <span class="font-semibold">Album mới</span> của Travis Scott</h6>
                                                <p class="mb-0 text-xs leading-tight text-slate-400 dark:text-white/80">
                                                    <i class="mr-1 fa fa-clock"></i>
                                                    1 ngày trước
                                                </p>
