                ...
                <form action="{{ route('admin.service-packages.update', $package->id) }}" method="POST">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="w-full max-w-full px-3 lg:w-6/12 lg:flex-none">
                            <div class="mb-4">
                                ...
                                <input type="text" name="duration" id="duration" class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" value="{{ old('duration', $package->duration) }}" placeholder="Ví dụ: 1 tháng, 3 tháng..." required>
                                @error('duration')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div id="features-container">
                                    ...
                                    <div class="flex items-center mb-2 feature-item">
                                        ...
                                        <button type="button" class="remove-feature inline-block px-3 py-2 text-xs font-bold text-center text-white uppercase align-middle transition-all bg-red-600 border-0 rounded-lg cursor-pointer hover:scale-102 active:opacity-85 hover:shadow-xs leading-normal ease-in tracking-tight-rem shadow-md bg-150 bg-x-25" {{ $index == 0 && count($package->features) == 1 ? 'style=display:none' : '' }}>
                    ...
                    <div class="flex items-center justify-end pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" class="inline-block px-6 py-2 text-xs font-bold text-center text-white uppercase align-middle transition-all bg-blue-600 border-0 rounded-lg cursor-pointer hover:scale-102 active:opacity-85 hover:shadow-xs leading-normal ease-in tracking-tight-rem shadow-md bg-150 bg-x-25">
                            <i class="fas fa-save mr-1"></i>Cập nhật gói dịch vụ
                        </button>
                    </div>
                </form>
            </div>
