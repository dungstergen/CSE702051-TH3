        ...
        <div class="control-panel">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                ...
                <div class="flex space-x-3 mt-4 lg:mt-0">
                    ...
                    <button
                        class="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-xl font-medium transition-colors">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex space-x-3">
                    ...
                    <input type="text" id="search-plate" placeholder="Tìm theo biển số xe..."
                        class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="overflow-x-auto">
                <table class="w-full table-auto">
                    <thead>
                        <tr class="bg-gray-50">
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Biển
                                số</th>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Thời
                                gian đỗ</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Phí
                                dự kiến</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr class="vehicle-item hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap"><span
                                    class="plate-number font-medium text-gray-900">29A-12345</span></td>
                        ...
                        <tr class="vehicle-item hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap"><span
                                    class="plate-number font-medium text-gray-900">30B-67890</span></td>
                        ...
                        <tr class="vehicle-item hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap"><span
                                    class="plate-number font-medium text-gray-900">31C-11111</span></td>
