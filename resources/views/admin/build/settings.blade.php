        ...
        <div class="settings-section">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="A1-A40, B1-B35" id="vipSpots"
                        placeholder="Ví dụ: A1-A10, B1-B5">
                </div>

                <div class="form-group">
                    <label class="form-label">Vị trí dành cho người khuyết tật</label>
                    <input type="text" class="form-input" value="A1-A5, B1-B3" id="disabledSpots"
                        placeholder="Ví dụ: A1-A3, B1-B2">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="C1-C20" id="electricVehicleSpots"
                        placeholder="Ví dụ: C1-C10">
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-top: 20px;">
            ...
            <div>
                ...
                <div style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; font-weight: 500;">Thời gian tự động đăng xuất
                        (phút):</label>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 10px; border: 1px solid #dee2e6;"><span
                                style="background: #dc3545; color: white; padding: 2px 6px; border-radius: 4px; font-size: 12px;">Super
                                Admin</span></td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">2 phút trước</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;"><span
                                style="background: #28a745; color: white; padding: 2px 6px; border-radius: 4px; font-size: 12px;">Hoạt
                                động</span></td>
                        <td style="padding: 10px; border: 1px solid #dee2e6; text-align: center;">
                            <button class="btn btn-sm"
                                style="background: #ffc107; color: black; padding: 4px 8px; font-size: 12px;"
                                onclick="editUser('admin')">Sửa</button>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">manager1</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;"><span
                                style="background: #007bff; color: white; padding: 2px 6px; border-radius: 4px; font-size: 12px;">Manager</span>
                        </td>
                        ...
                        <td style="padding: 10px; border: 1px solid #dee2e6; text-align: center;">
                            <button class="btn btn-sm"
                                style="background: #ffc107; color: black; padding: 4px 8px; font-size: 12px; margin-right: 5px;"
                                onclick="editUser('manager1')">Sửa</button>
                            <button class="btn btn-sm"
                                style="background: #dc3545; color: white; padding: 4px 8px; font-size: 12px;"
                                onclick="deactivateUser('manager1')">Vô hiệu</button>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">staff1</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;"><span
                                style="background: #6c757d; color: white; padding: 2px 6px; border-radius: 4px; font-size: 12px;">Staff</span>
                        </td>
                        ...
                        <td style="padding: 10px; border: 1px solid #dee2e6; text-align: center;">
                            <button class="btn btn-sm"
                                style="background: #ffc107; color: black; padding: 4px 8px; font-size: 12px; margin-right: 5px;"
                                onclick="editUser('staff1')">Sửa</button>
                            <button class="btn btn-sm"
                                style="background: #dc3545; color: white; padding: 4px 8px; font-size: 12px;"
                                onclick="deactivateUser('staff1')">Vô hiệu</button>
                        </td>
                    </tr>
                </tbody>
            </table>
