...
@section('content')
    <div class="card">
        ...
        <form action="#" method="POST" style="max-width: 800px;">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
                ...
                <div>
                    ...
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 8px; font-weight: 600; color: #333;">Họ và tên *</label>
                ...
                <div>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <textarea name="notes" rows="4"
                                  style="width: 100%; padding: 12px; border: 2px solid #ddd; border-radius: 8px; font-size: 16px; resize: vertical; transition: border-color 0.3s;"
                                  placeholder="Ghi chú thêm về khách hàng (tùy chọn)"
                                  onfocus="this.style.borderColor='#28a745'"
                                  onblur="this.style.borderColor='#ddd'"></textarea>
                    </div>
                </div>
            ...
            <!-- Ưu đãi VIP -->
            <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); padding: 25px; border-radius: 15px; margin: 30px 0; border: 2px solid #28a745;">
                <h4 style="color: #28a745; margin-bottom: 20px; text-align: center;">
                    ⭐ Ưu đãi dành cho thẻ VIP ⭐
                </h4>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px;">
                    <div style="display: flex; align-items: center; gap: 12px; background: white; padding: 15px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            <div style="text-align: center; margin-top: 40px; padding-top: 30px; border-top: 2px solid #eee;">
                ...
                <button type="reset" class="btn btn-warning"
                        style="font-size: 18px; padding: 15px 40px; min-width: 180px;">
        ...
        <!-- Thông tin hướng dẫn -->
        <div style="background: #e3f2fd; padding: 20px; border-radius: 10px; margin-top: 30px; border-left: 5px solid #2196f3;">
