...
@section('content')
    ...
    <div class="row" style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-bottom: 30px;">
        <div class="card">
            ...
            <div
                style="height: 300px; display: flex; align-items: end; gap: 10px; padding: 20px; background: #f8f9fa; border-radius: 8px; margin-top: 15px;">
                <div style="background: #ff6b35; width: 40px; height: 80%; border-radius: 4px;" title="Thứ 2: 1,890,000đ">
                </div>
                <div style="background: #ff6b35; width: 40px; height: 95%; border-radius: 4px;" title="Thứ 3: 2,135,000đ">
                </div>
                <div style="background: #ff6b35; width: 40px; height: 75%; border-radius: 4px;" title="Thứ 4: 1,675,000đ">
                </div>
                <div style="background: #ff6b35; width: 40px; height: 85%; border-radius: 4px;" title="Thứ 5: 1,920,000đ">
                </div>
                <div style="background: #ff6b35; width: 40px; height: 90%; border-radius: 4px;" title="Thứ 6: 2,045,000đ">
                </div>
                <div style="background: #ff6b35; width: 40px; height: 100%; border-radius: 4px;" title="Thứ 7: 2,280,000đ">
                </div>
                <div style="background: #28a745; width: 40px; height: 110%; border-radius: 4px;"
                    title="Chủ nhật: 2,456,000đ"></div>
            </div>
