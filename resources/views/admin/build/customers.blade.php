        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex space-x-3 mt-4 lg:mt-0">
                    <button
                        class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl font-medium transition-colors"
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                <div class="flex space-x-4">
                    <div class="relative">
                        <input type="text" id="searchCustomer" placeholder="Tìm theo tên, SĐT, biển số..."
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="customerGrid">
                ...
                <div class="customer-card customer-item" data-type="vip" data-status="active">
                    ...
                    <div class="flex space-x-2">
                        <button
                            ...
                            onclick="viewCustomerDetails('001234')">
                        ...
                        <button
                            ...
                            onclick="contactCustomer('0912345678')">
                ...
                <div class="customer-card customer-item" data-type="regular" data-status="inactive">
                    ...
                    <div class="flex space-x-2">
                        <button
                            class="flex-1 bg-blue-50 text-blue-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-blue-100 transition-colors"
                            onclick="viewCustomerDetails('001235')">
                            <i class="fas fa-eye mr-1"></i>
                            Chi tiết
                        </button>
                        <button
                            class="flex-1 bg-green-50 text-green-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-green-100 transition-colors"
                            onclick="contactCustomer('0923456789')">
                            <i class="fas fa-phone mr-1"></i>
                            Liên hệ
                        </button>
                    </div>
                ...
                <div class="customer-card customer-item" data-type="vip" data-status="active">
                    ...
                    <div class="flex space-x-2">
                        <button
                            class="flex-1 bg-blue-50 text-blue-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-blue-100 transition-colors"
                            onclick="viewCustomerDetails('001236')">
                            <i class="fas fa-eye mr-1"></i>
                            Chi tiết
                        </button>
                        <button
                            class="flex-1 bg-green-50 text-green-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-green-100 transition-colors"
                            onclick="contactCustomer('0934567890')">
                            <i class="fas fa-phone mr-1"></i>
                            Liên hệ
                        </button>
                    </div>
                ...
                <div class="customer-card customer-item" data-type="regular" data-status="inactive">
                    ...
                    <div class="flex space-x-2">
                        <button
                            class="flex-1 bg-blue-50 text-blue-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-blue-100 transition-colors"
                            onclick="viewCustomerDetails('001237')">
                            <i class="fas fa-eye mr-1"></i>
                            Chi tiết
                        </button>
                        <button
                            class="flex-1 bg-green-50 text-green-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-green-100 transition-colors"
                            onclick="contactCustomer('0945678901')">
                            <i class="fas fa-phone mr-1"></i>
                            Liên hệ
                        </button>
                    </div>
                ...
                <div class="customer-card customer-item" data-type="regular" data-status="active">
                    ...
                    <div class="flex space-x-2">
                        <button
                            class="flex-1 bg-blue-50 text-blue-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-blue-100 transition-colors"
                            onclick="viewCustomerDetails('001238')">
                            <i class="fas fa-eye mr-1"></i>
                            Chi tiết
                        </button>
                        <button
                            class="flex-1 bg-green-50 text-green-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-green-100 transition-colors"
                            onclick="contactCustomer('0956789012')">
                            <i class="fas fa-phone mr-1"></i>
                            Liên hệ
                        </button>
                    </div>
                ...
                <div class="customer-card customer-item" data-type="vip" data-status="inactive">
                    ...
                    <div class="flex space-x-2">
                        <button
                            class="flex-1 bg-blue-50 text-blue-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-blue-100 transition-colors"
                            onclick="viewCustomerDetails('001239')">
                            <i class="fas fa-eye mr-1"></i>
                            Chi tiết
                        </button>
                        <button
                            class="flex-1 bg-green-50 text-green-600 py-2 px-3 rounded-lg text-sm font-medium hover:bg-green-100 transition-colors"
                            onclick="contactCustomer('0967890123')">
                            <i class="fas fa-phone mr-1"></i>
                            Liên hệ
                        </button>
                    </div>
            ...
            <div class="flex justify-center mt-6">
                <nav class="flex space-x-2">
                    <button
                        class="px-3 py-2 text-sm text-gray-500 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">Trước</button>
                    <button class="px-3 py-2 text-sm text-white bg-blue-600 rounded-lg">1</button>
                    <button
                        class="px-3 py-2 text-sm text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">2</button>
                    <button
                        class="px-3 py-2 text-sm text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">3</button>
                    <button
                        class="px-3 py-2 text-sm text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">Sau</button>
                </nav>
            </div>
        </div>
    </div>
...
@section('additional_js')
    ...
    <div class="activity-item">
        ...
        <div
            style="margin-left: auto; padding: 4px 8px; background: #6c757d; color: white; border-radius: 4px; font-size: 12px;">
            Thường
        </div>
    </div>
    ...
    <div class="activity-item">
        ...
        <div
            style="margin-left: auto; padding: 4px 8px; background: #17a2b8; color: white; border-radius: 4px; font-size: 12px;">
            Mới
        </div>
    </div>
    ...
    <div class="activity-item">
        ...
        <div
            style="margin-left: auto; padding: 4px 8px; background: #28a745; color: white; border-radius: 4px; font-size: 12px;">
            VIP
        </div>
    </div>
    ...
    <div class="row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 30px;">
        <div class="card">
            ...
            <div style="display: flex; flex-direction: column; gap: 10px; margin-top: 15px;">
                ...
                <a href="{{ route('admin.customers.vip') }}" class="btn btn-success"
                    style="text-decoration: none; text-align: center;">
