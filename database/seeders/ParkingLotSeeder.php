    ...
    public function run(): void
    {
        $parkingLots = [
            [
                ...
                'amenities' => 'Camera an ninh, Bảo vệ 24/7, Có mái che, Gần trung tâm',
                'facilities' => json_encode(['Camera an ninh', 'Bảo vệ 24/7', 'Có mái che', 'Gần trung tâm']),
                'contact_info' => 'Hotline: 0901234567',
            ],
            [
                ...
                'amenities' => 'Hoạt động 24/7, Gần sân bay, An ninh cao, Xe bus đưa đón',
                'facilities' => json_encode(['Hoạt động 24/7', 'Gần sân bay', 'An ninh cao', 'Xe bus đưa đón']),
                'contact_info' => 'Hotline: 0901234568',
            ],
            [
                ...
                'amenities' => 'Giá cả hợp lý, Khu vực an toàn, Gần khu dân cư',
                'facilities' => json_encode(['Giá cả hợp lý', 'Khu vực an toàn', 'Gần khu dân cư']),
                'contact_info' => 'Hotline: 0901234569',
            ]
        ];
